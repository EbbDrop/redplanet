...
class redplanet(pluginTemplate):
    __model__ = "redplanet"
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "redplanet")
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for redplanet start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs
    ...
    def runTests(self, testList):
	  ...
	  # echo statement.
          if self.target_run:
            ...
            simcmd = self.dut_exe + ' --signature {1} {0}'.format(elf, sig_file)
          else:
            simcmd = 'echo "NO RUN"'
